    ...
    <div className="min-h-screen bg-gradient-to-b from-black to-purple-950 text-white">
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 text-center">
          About <span className="text-purple-400">Catch Me If You Can</span>
        </h1>
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="bg-black/60 border-purple-500/30 mb-8 p-6">
            ...
            <p className="mb-4 text-gray-100">
              Catch Me If You Can is a psychological game that tests your ability to detect deception and make decisions 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <Card className="bg-black/60 border-purple-500/30 p-6">
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-100">
                ...
                <li>Use special abilities like "Peek" and "Beg" when they become available</li>
                <li>Manage your lives - you have 3 chances before game over</li>
            ...
            <Card className="bg-black/60 border-purple-500/30 p-6">
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-100">
                ...
                <li>Dynamic special abilities that appear during gameplay</li>
                <li>Lives system with chances to earn back lost lives</li>
                <li>Achievements and leaderboard rankings</li>
                <li>Wallet integration for verified achievements</li>
              </ul>
            </Card>
          </div>
          ...
          <Card className="bg-black/60 border-purple-500/30 mb-8 p-6">
            ...
            <p className="mb-4 text-gray-100">
              Catch Me If You Can leverages several psychological principles to create a compelling gaming experience:
            </p>
          ...
          <div className="text-center mb-12">
            <h2 className="text-2xl font-bold mb-6 text-white">Ready to test your psychological resilience?</h2>
            <Link to="/game">
          ...
          <div className="text-center text-sm text-gray-400">
            <p className="mb-2">Catch Me If You Can © 2025 - All Rights Reserved</p>
            <p>
              A psychological game of deception and intuition. The game contains themes related to manipulation 
              and psychological deception. Recommended for players age 18+.
            </p>
          </div>
        </div>
      </div>
